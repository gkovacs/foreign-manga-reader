...
(function() {
  var addIdsToHierarchy, addSentence, addSentences, getChildrenOfId, getMaxDepth, getUrlParameters, hierarchyToTerminals, hierarchyWithIdToTerminals, initializePopup, makeDivs, openTranslationPopup, renderSentence, root, submitTranslation;
  ...
  makeDivs = function(subHierarchy, lang, translations, maxdepth, depth) {
    ...
    basediv.hoverId();
    (function(foreignText, translation, lang) {
  ...
  addSentence = root.addSentence = function(sentence, lang, renderTarget) {
  ...
  openTranslationPopup = root.openTranslationPopup = function(sentenceToTranslate, translation, lang) {
  ...
  initializePopup = root.initializePopup = function(lang) {
    ...
    return popupTranslateDisplay.dialog({
      ...
      'create': function() {
        ...
        return $('#translationInput').keypress(function(e) {
          var inputtedText, origPhrase, translation;
          if (e.keyCode === 13) {
