...
(function() {
  var assignVariable, callOnceElementAvailable, callOnceObjectAvailable, executeInPage, getCurrentDialog, getLineNumFromText, goToDialog, goToNextDialog, goToPreviousDialog, haveNewText, myGlobalCode, popupSentenceDisplay, root, trimSelectedText;
  ...
  $(document).ready(assignVariable('callOnceObjectAvailable', callOnceObjectAvailable), assignVariable('getLineNumFromText', getLineNumFromText), executeInPage(function() {
    ...
    if (e.keyCode === 40 || e.keyCode === 39) {
      return goToNextDialog();
    } else if (e.keyCode === 38 || e.keyCode === 37) {
      return goToPreviousDialog();
    }
