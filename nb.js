...
(function() {
  var assignVariable, callOnceElementAvailable, callOnceObjectAvailable, cropBase64Image, executeInPage, getCurrentDialog, getLineNumFromText, getOCR, goToDialog, goToNextDialog, goToPreviousDialog, haveNewText, myGlobalCode, popupSentenceDisplay, prevScreenshotCoordinates, root, trimSelectedText;
  ...
  }), root.serverLocation = 'http://localhost:1357', popupSentenceDisplay = $('<div id="popupSentenceDisplay">dialog content is here</div>'), popupSentenceDisplay.dialog({
    'autoOpen': false,
    'modal': false,
    'title': '',
    'position': ['right', 'top'],
